...
from animotion.config.utils import next_folder_in_sequence_in
...
class EventHandlerContainer(containers.DeclarativeContainer):
    ...
    _image_recorder_target = providers.Factory(
        next_folder_in_sequence_in,
        root_folder=providers.Factory(Path, config.app.image_target_folder),
    )
    ...
    _video_recorder_target = providers.Factory(
        next_folder_in_sequence_in,
        root_folder=providers.Factory(Path, config.app.video_target_folder),
    )
